...
export function Menu() {
  ...
  return (
      <div className="flex items-center justify-between p-4 bg-zinc-900 text-zinc-100">
        {/* Horizontal Navigation */}
        <nav className="flex space-x-4">
          <Link href="/" className="px-4 py-2 rounded-md hover:bg-zinc-800">Home</Link>
          <Link href="/chords" className="px-4 py-2 rounded-md hover:bg-zinc-800">Chords</Link>
        </nav>
